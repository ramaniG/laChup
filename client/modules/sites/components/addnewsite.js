...
import StateSelection from '../../core/containers/stateselection';
  ...
  render() {
    ...
    return (
      <div className="panel panel-default">
        <div className="panel-heading">Adding New Site</div>
        <div className="panel-body form-horizontal">
          ...
          <div className="form-group">
            ...
            <div className="col-sm-10">
              <StateSelection countryID="1" onChange={this.handleStateChange.bind(this)}/>
            </div>
          </div>
          <div className="form-group">
